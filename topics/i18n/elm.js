...
var _pinx$elm_i18n$Translation$defaultTranslation = {welcome: 'Welcome', logout: 'Logout'};
var _pinx$elm_i18n$Translation$Model = F2(
	function (a, b) {
		return {welcome: a, logout: b};
	});

var _pinx$elm_i18n$Model$Model = F3(
	function (a, b, c) {
		return {mdl: a, language: b, translations: c};
	});
var _pinx$elm_i18n$Model$Dutch = {ctor: 'Dutch'};
var _pinx$elm_i18n$Model$English = {ctor: 'English'};
var _pinx$elm_i18n$Model$initialModel = {mdl: _MichaelCombs28$elm_mdl$Material$model, language: _pinx$elm_i18n$Model$English, translations: _pinx$elm_i18n$Translation$defaultTranslation};
var _pinx$elm_i18n$Model$SetTranslations = function (a) {
	return {ctor: 'SetTranslations', _0: a};
};
var _pinx$elm_i18n$Model$GetTranslations = function (a) {
	return {ctor: 'GetTranslations', _0: a};
};
var _pinx$elm_i18n$Model$Mdl = function (a) {
	return {ctor: 'Mdl', _0: a};
};

var _pinx$elm_i18n$Server$languageDecoder = A3(
	...
	A3(
		...
		'welcome',
		_elm_lang$core$Json_Decode$string,
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_pinx$elm_i18n$Translation$Model)));
var _pinx$elm_i18n$Server$decodeLanguages = function (raw) {
	return A2(_elm_lang$core$Json_Decode$decodeValue, _pinx$elm_i18n$Server$languageDecoder, raw);
};
var _pinx$elm_i18n$Server$endpoint = '/';
var _pinx$elm_i18n$Server$getTranslations = function (language) {
	var url = A2(
		_elm_lang$core$Basics_ops['++'],
		_pinx$elm_i18n$Server$endpoint,
		A2(
			_elm_lang$core$Basics_ops['++'],
			_elm_lang$core$Basics$toString(language),
			'.json'));
	return A2(
		_elm_lang$http$Http$send,
		_pinx$elm_i18n$Model$SetTranslations,
		A2(_elm_lang$http$Http$get, url, _pinx$elm_i18n$Server$languageDecoder));
};

var _pinx$elm_i18n$View$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_0: A2(
				_elm_lang$html$Html$button,
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Events$onClick(
						_pinx$elm_i18n$Model$GetTranslations(_pinx$elm_i18n$Model$English)),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
			...
			_1: {
				...
				_0: A2(
					_elm_lang$html$Html$button,
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onClick(
							_pinx$elm_i18n$Model$GetTranslations(_pinx$elm_i18n$Model$Dutch)),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('Dutch'),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					...
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html$text(model.translations.welcome),
						_1: {
							ctor: '::',
							_0: A2(
								_elm_lang$html$Html$br,
							...
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html$text(model.translations.logout),
								_1: {ctor: '[]'}
							}
						}
					}
...
var _pinx$elm_i18n$Main$msgToCmd = function (msg) {
	return A2(
		_elm_lang$core$Task$perform,
		_elm_lang$core$Basics$always(msg),
...
var _pinx$elm_i18n$Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$none;
};
var _pinx$elm_i18n$Main$update = F2(
	function (msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'Mdl':
			...
			case 'GetTranslations':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _pinx$elm_i18n$Server$getTranslations(_p0._0)
				};
			default:
				if (_p0._0.ctor === 'Ok') {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								translations: A2(_elm_lang$core$Debug$log, 'translations', _p0._0._0)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
...
var _pinx$elm_i18n$Main$init = {ctor: '_Tuple2', _0: _pinx$elm_i18n$Model$initialModel, _1: _elm_lang$core$Platform_Cmd$none};
var _pinx$elm_i18n$Main$main = _elm_lang$html$Html$program(
	{init: _pinx$elm_i18n$Main$init, view: _pinx$elm_i18n$View$view, subscriptions: _pinx$elm_i18n$Main$subscriptions, update: _pinx$elm_i18n$Main$update})();

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _pinx$elm_i18n$Main$main !== 'undefined') {
    _pinx$elm_i18n$Main$main(Elm['Main'], 'Main', undefined);
}
